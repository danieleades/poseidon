...
impl Positions {
    ...
    pub fn most_novel_coordinates(&self, recipient: &NodeId, n_max: usize) -> Vec<&Datum> {
        self.most_novel_coordinates_with_optional_threshold(recipient, n_max, None)
    }
    ...
    /// This method returns at most `n_max` results
    ///
    /// The search stops when the geometric novelty of a subsegment is less than `threshold` times the geometric novelty of its parent segment.
    #[must_use]
    pub fn most_novel_coordinates_with_threshold(
        &self,
        recipient: &NodeId,
        n_max: usize,
        threshold: f64,
    ) -> Vec<&Datum> {
        self.most_novel_coordinates_with_optional_threshold(recipient, n_max, Some(threshold))
    }
    ...
    #[must_use]
    fn most_novel_coordinates_with_optional_threshold(
        &self,
        recipient: &NodeId,
        n_max: usize,
