...
use crate::{coordinate::Coordinate, transmission_history::TransmissionHistory};
...
impl Positions {
    ...
    ///
    /// This method inserts a new data point into the collection with the
    /// specified timestamp and coordinate. The method returns the ID of the
    ...
    ///
    /// The most novel coordinates are those that are furthest from the polyline
    /// generated by the already-transmitted (100% probability) coordinates,
    /// weighted by the probability that the recipient has not received them
    /// already.
    ///
...
mod tests {
    ...
    fn test_most_novel_coordinates() {
        ...
        // Assert that the most novel positions contain the ids of points id0, id2, and
        // id4
